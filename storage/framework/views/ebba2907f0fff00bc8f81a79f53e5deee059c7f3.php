	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body custom-edit-service">
				...
				<!-- Add Medicine -->
				<form method="post" enctype="multipart/form-data" autocomplete="off" action="<?php echo e(route('purchases.store')); ?>">
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\codeastro\Laravel\Pharmacy-management-system\resources\views/admin/purchases/create.blade.php ENDPATH**/ ?>