            ...
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <img class="img-fluid" src="<?php echo e(!empty(AppSettings::get('logo')) ? asset('storage/'.AppSettings::get('logo')): asset('assets/img/logo.png')); ?>" alt="Logo">
                    </div>
...
</html><?php /**PATH F:\codeastro\Laravel\Pharmacy-management-system\resources\views/admin/layouts/plain.blade.php ENDPATH**/ ?>