...
<div class="header">
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown has-arrow">
			<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
				<span class="user-img"><img class="rounded-circle" src="<?php echo e(!empty(auth()->user()->avatar) ? asset('storage/users/'.auth()->user()->avatar): asset('assets/img/avatar.png')); ?>" width="31" alt="avatar"></span>
			</a>
			<div class="dropdown-menu">
				<div class="user-header">
					<div class="avatar avatar-sm">
						<img src="<?php echo e(!empty(auth()->user()->avatar) ? asset('storage/users/'.auth()->user()->avatar): asset('assets/img/avatar.png')); ?>" alt="User Image" class="avatar-img rounded-circle">
					</div>
					<div class="user-text">
...
<!-- /Header --><?php /**PATH F:\codeastro\Laravel\Pharmacy-management-system\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>